...
|---|---|---|---|
| **E1★ two-axis** | RQ1 | axis1: per-user reliance over-dispersion (beta-binomial) + difficulty-controlled within-task counterfactual diff; axis2: panel over-reliance level on wrong AI; both vs 4 baselines | axis1 significant vs mean-predictor after difficulty control, CI∌0; axis2 flags dark low-dispersion design as high risk, converges with E4 |
